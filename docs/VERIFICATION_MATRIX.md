...
| Unit tests | Verified | `npm.cmd test` | `tests/`, `.github/workflows/ci.yml` | 15 Vitest tests currently cover storage, prompts, safety, MCP noauth tool metadata, runner args, rate-limit detection, mock workflows, verification pause, and resume behavior. |
